...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2022 at 01:46 PM
...
INSERT INTO `agents` (`id`, `name`, `status`, `email`, `password`, `email_verified_at`, `created_at`, `updated_at`) VALUES
(31, 'Saddam', '1', 'Avi@gmail.com', '$2y$10$BD9abx7qrHjC1i2.KCbgfepT1hPV.RcvfoiH3JTiH2MPOGLHshud6', NULL, '2022-10-10 02:08:52', '2022-10-10 02:08:52');
...
CREATE TABLE `agent_infos` (
  ...
  `agent_Autostring_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `registration_date` datetime NOT NULL,
  `mobileNumber1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobileNumber2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_zone_area` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_division` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `agent_infos` (`id`, `agent_id`, `image`, `agent_Autostring_id`, `registration_date`, `mobileNumber1`, `mobileNumber2`, `agent_zone_area`, `agent_division`, `present_address`, `permanent_address`, `created_at`, `updated_at`) VALUES
(21, 31, '1665389332.jpg', '#964US5', '2022-10-07 00:00:00', '01613101011', '555555555555555', 'Jamalpur', 'Sylhet', 'fdghdfghfdsg', 'asftasdfasdtfd', '2022-10-10 02:08:52', '2022-10-10 02:08:52');
...
INSERT INTO `banks` (`id`, `short_name`, `full_name`, `code`, `routing_number`, `created_at`, `updated_at`) VALUES
(1, 'Dbbl', 'Das bangla bank limited', '001', '012425', NULL, NULL),
(2, 'City Bank', 'City Bank', '01244', '22125220552', NULL, NULL);
...
(14, '2022_10_01_064238_create_banks_table', 4),
(15, '2022_09_27_061140_create_agents_table', 5),
(17, '2022_10_01_064027_create_agent_infos_table', 6),
(18, '2022_10_01_064218_create_payment_details_table', 7);
...
CREATE TABLE `payment_details` (
  ...
  `Mobile_banking` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `banking_mobile_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `payment_details` (`id`, `agent_id`, `bank_id`, `account_number`, `Mobile_banking`, `banking_mobile_number`, `created_at`, `updated_at`) VALUES
(16, 31, 2, '68877878', '5555555', '8585855885', '2022-10-10 02:08:52', '2022-10-10 02:08:52');
